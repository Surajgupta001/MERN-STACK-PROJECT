...
function Navbar() {
    ...
    return (
        <div className={`flex items-center justify-between px-4 py-4 border-b border-gray-500 sm:px-10 md:px-14 lg:px-36 ${isCourseListPage ? 'bg-white' : 'bg-cyan-100/70'}`}>
            ...
            <div className='items-center hidden gap-5 text-gray-500 md:flex'>
                ...
                {user ? <UserButton /> : <button onClick={() => openSignIn()} className='px-5 py-2 text-white bg-blue-600 rounded-full'>create Account</button>}
            </div>
            {/* For Phone Screen */}
