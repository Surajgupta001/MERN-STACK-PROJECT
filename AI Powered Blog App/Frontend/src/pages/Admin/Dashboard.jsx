    ...
    return (
        <div className='flex-1 p-4 md:p-10 bg-blue-50/50'>
            <div className='flex flex-wrap gap-4'>
                <div className='flex items-center gap-4 p-4 transition-all bg-white rounded shadow cursor-pointer min-w-58 hover:scale-105'>
            ...
            <div>
                ...
                <div className='relative max-w-4xl overflow-x-auto bg-white rounded-md shadow scrollbar-hide'>
