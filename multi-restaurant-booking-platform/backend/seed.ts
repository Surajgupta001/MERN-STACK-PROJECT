...
import RestaurantModel from './src/models/restaurant.models.js';
import BookingModel from './src/models/booking.models.js';
    ...
    try {
        ...
        const updatedRestaurantsData = restaurantsData.map((rest, idx) => {
            ...
            return {
                ...
                owner: ownerUser._id,
                status: 'approved',
                totalSeats: 20 + idx * 5, // Example: Increment total seats for each restaurant
            }
        })

        await RestaurantModel.insertMany(updatedRestaurantsData);
