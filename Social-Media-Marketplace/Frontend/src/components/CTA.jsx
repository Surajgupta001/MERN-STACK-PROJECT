...
function CTA() {
    return (
        <div className="max-w-5xl p-px mx-2 md:mx-auto rounded-2xl bg-linear-to-r from-purple-600/20 to-blue-500/30">
            <div className="flex flex-col items-center justify-center text-center py-12 md:py-16 rounded-[15px] bg-linear-to-r from-[#F3EAFF] to-[#E1EFFF]">
                <div className="flex items-center justify-center bg-white px-3 py-1.5 shadow gap-1 rounded-full text-xs">
                    ...
                    <span className="font-medium text-transparent bg-linear-to-r from-purple-600 to-blue-500 bg-clip-text">Trusted by Millions</span>
                </div>
                <h2 className="text-2xl md:text-4xl font-medium mt-2 leading-[1.2]">
                    Sell your Social Accounts <br />
                    <span className="text-transparent bg-linear-to-r from-purple-600 to-blue-500 bg-clip-text">with confiedence </span>
                    & earn money
                </h2>
                <p className="max-w-lg mt-2 text-slate-500 max-md:text-sm">We are the leading social media marketplace that connects brands with their customers with our user-friendly interface.</p>
