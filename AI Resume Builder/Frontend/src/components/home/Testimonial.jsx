...
function Testimonial() {
    ...
    const CreateCard = ({ card }) => (
        <div className="p-4 mx-4 transition-all duration-200 rounded-lg shadow hover:shadow-lg w-72 shrink-0">
                ...
                <img className="rounded-full w-11 h-11" src={card.image} alt="User Image" />
            ...
            <p className="py-4 text-sm text-gray-800">Radiant made undercutting all of our competitors an absolute breeze.</p>
        </div>
    );
