    ...
    return (
        <div className='px-4 py-24 sm:px-20 xl:px-32'>
            <div className='text-center'>
                ...
                <p className='max-w-lg mx-auto text-gray-500'>Don't just take our word for it. Here's what our users are saying.</p>
            </div>
                ...
                {dummyTestimonialData.map((testimonial, index) => (
                    <div key={index} className='p-8 m-4 max-w-xs rounded-lg bg-[#FDFDFE] shadow-lg border border-gray-100 hover:-translate-y-1 transition duration-300 cursor-pointer'>
                        ...
                        <div className='flex items-center gap-4'>
                            <img src={testimonial.image} className='object-contain w-12 rounded-full' alt='' />
