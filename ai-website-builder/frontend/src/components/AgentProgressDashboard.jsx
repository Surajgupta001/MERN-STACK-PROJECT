...
export default function AgentProgressDashboard({ project }) {
    ...
    return (
        <div className="flex flex-col items-center justify-center w-full h-full p-6 overflow-y-auto bg-zinc-50 md:p-12">
            <div className="relative w-full max-w-xl p-6 overflow-hidden bg-white border border-zinc-200 rounded-2xl md:p-8">
                {/* Status Header */}
                ...
                {isFailed && project.error && (
                    <div className="p-4 mb-6 text-sm font-medium text-red-700 border border-red-100 rounded-lg bg-red-50">
                        Error: {project.error}
                    </div>
                )}
                ...
                {planned.length > 0 && !isFailed && (
                    <div className="mb-6">
                        ...
                        <div className="w-full h-1.5 bg-zinc-200 rounded-full overflow-hidden">
                            <div
                                className="h-full transition-all duration-500 ease-out bg-zinc-700"
