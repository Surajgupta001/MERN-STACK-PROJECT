...
function MyProfile() {
    ...
    return userData && (
        <div className='flex flex-col max-w-lg gap-2 pt-5 text-sm'>
            ...
            <div>
                <p className='mt-3 underline text-neutral-600'>CONTACT INFORMATION</p>
            ...
            <div>
                ...
                <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
                    ...
                    {
                        isEdit
                            ? <select className='bg-gray-100 max-w-20' value={userData.gender} onChange={(e) => setUserData(prev => ({ ...prev, gender: e.target.value }))}>
            ...
            <div className='mt-5'>
                {
                    isEdit
                        ? <button className='px-4 py-2 text-white bg-blue-500 rounded-full hover:bg-blue-600' onClick={updateUserProfileData}>Save Information</button>
                        : <button className='px-4 py-2 text-gray-700 bg-gray-300 rounded-full hover:bg-gray-400' onClick={() => setIsEdit(true)}>Edit Information</button>
                }
            </div>
        </div>
    )
