...
function Connections() {
  ...
  // Handle unfollow functionality here
  ...
  // Handle accept connection functionality here
                ...
                <div className='flex gap-2 mt-4 max-sm:flex-col'>
                  ...
                  }
                  {
                    currentTabs === 'Following' && (
                      <button onClick={() => handleUnfollow(user._id)} className='w-full p-2 text-sm text-black transition rounded cursor-pointer bg-slate-100 hover:bg-slate-200 active:scale-95'>
                        Unfollow
                      </button>
                    )
                  }
                  {
                    currentTabs === 'Pending' && (
                      <button onClick={() => acceptConnection(user._id)} className='w-full p-2 text-sm text-black transition rounded cursor-pointer bg-slate-100 hover:bg-slate-200 active:scale-95'>
                        Accept
                      </button>
                    )
                  }
