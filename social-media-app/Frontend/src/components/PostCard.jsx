...
function PostCard({ post }) {
    ...
    return (
        <div className='w-full max-w-2xl p-4 space-y-4 bg-white shadow rounded-xl'>
            {/* User Info */}
            ...
            {/* Content */}
            {post.content && <div className='text-sm text-gray-800' dangerouslySetInnerHTML={{ __html: postWithHashtags }} />}
            {/* Images */}
            ...
            {/* Actions */}
            <div className='flex items-center gap-4 pt-2 text-sm text-gray-600 border-t border-gray-300'>
