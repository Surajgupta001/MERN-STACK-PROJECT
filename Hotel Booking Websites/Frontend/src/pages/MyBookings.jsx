...
function MyBookings() {
    ...
    return (
        <div className='px-4 py-28 md:pb-35 md:pt-32 md:px-16 lg:px-24 xl:px-32'>
                ...
                {bookings.map((booking) => (
                    <div key={booking._id} className='grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first:border-t'>
                        ...
                        <div className='flex flex-col md:flex-row'>
                            <img src={booking.room.images[0]} alt="hotel-img" className='object-cover rounded shadow min-md:w-44' />
                        ...
                        {/* Date and Timing */}
                        <div className='flex flex-row gap-8 mt-3 md:items-center md:gap-12'>
                            <div>
                                <p>Check-In:</p>
                        ...
                        <div className='flex flex-col items-start justify-center pt-3'>
                            ...
                            {!booking.isPaid && (
                                <button className='px-4 py-1.5 mt-4 text-xs border border-gray-400 rounded-md hover:bg-gray-50 transition-all cursor-pointer'>Pay Now</button>
                            )}
                        </div>
                    </div>
                ))}
